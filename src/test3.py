...
## Read Mesh
if 1:
    from test3_read_lipo import read_lipo_csv
    ...
    mesh_path = '/Users/linxu/Files/Workspace/EM-FEM/data/test-T_A_Lipo.msh'
...
group_current_dict = {
    2: 1.55e06,  # group_id : I (current,A)
}
...
for group_id, current in group_current_dict.items():
    ...
    group_current_density_list[group_id] = 1.55e06
